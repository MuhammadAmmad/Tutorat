...
public class DummyData {
    ...
    public static List<Tutor> DUMMY_CREDENTIALS = new LinkedList<>();

    public static List<Tutor> DUMMY_CREDENTIALS_STUDENT = new LinkedList<>();
/*
    public DummyData() {
        user student1 = new Tutor("Chris", "Brooks");
        student1.setIdUtilisateur(1);
        student1.setUserName("chris_brooks");
        student1.setEmail("cbrooks0@comcast.net");
        student1.setPassword("password");
        DUMMY_CREDENTIALS.add((Tutor) student1);
        // student 2
        user student2 = new Tutor("Michelle", "Gordon");
        ...
        DUMMY_CREDENTIALS.add((Tutor)student2);

        // student 3
        user student3 = new Tutor("Kenneth", "Ross");
        ...
        DUMMY_CREDENTIALS.add((Tutor)student3);

        user student4 = new Tutor("Katherine", "Nichols");
