...
public class Registration extends AppCompatActivity /*implements LoaderCallbacks<Cursor>*/ {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refDatabase = FirebaseDatabase.getInstance().getReference().getRoot();
        ...
        loginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onError(FacebookException error) {
                Toast.makeText(getApplicationContext(), "Error login on facebook", Toast.LENGTH_SHORT).show();
            }
        });
    }
                ...
                mAuth.createUserWithEmailAndPassword(mEmail, mPassword).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            DatabaseReference currentUser_info;
                            if (userType == STUDENT) {
                                currentUser_info = refDatabase.child("STUDENT").child(userId);
                            } else {
                                currentUser_info = refDatabase.child("TUTOR").child(userId);
                            }
                            Map<String, Object> map = new HashMap<>();
                            map.put(user.getUsername(), user);
                            currentUser_info.updateChildren(map);
                        }
                    }
                });
