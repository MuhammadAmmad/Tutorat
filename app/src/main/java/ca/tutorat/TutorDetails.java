...
public class TutorDetails extends AppCompatActivity {
    ...
    private List<Tutor> experience = new LinkedList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myFullName.setText(TutorMainPage.tutor.getFirstName() + " " + TutorMainPage.tutor.getLastName());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_disconnect:
                Intent intent = new Intent(TutorDetails.this, MainActivity.class);
    ...
    private void populateTutor() {
        for (int i = 0; i < 5; i++) {
            experience.add(new Tutor("jds","dsei"));
        }
    }
    ...
    private class MyAdapter extends ArrayAdapter<Tutor> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Tutor currentTutor = experience.get(position);
            // find the icone
